...
class SlimDNSServer:
    ...
    def _checkConnectivity(self, timer):
        if self.station.isconnected():
            ...
            self.advertise_hostname(self.hostname)

            self.checkPacketsTimer.init(
                period=200, mode=Timer.PERIODIC, callback=self._checkPackets
            )
